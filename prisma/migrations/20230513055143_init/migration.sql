...
CREATE TABLE `BookDiscussion` (
    ...
    UNIQUE INDEX `BookDiscussion_postId_key`(`postId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ProConDiscussion` (
    ...
    UNIQUE INDEX `ProConDiscussion_postId_key`(`postId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ProConVote` (
    ...
    UNIQUE INDEX `ProConVote_userId_proConDiscussionId_key`(`userId`, `proConDiscussionId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `CommentDislike` (
    ...
    UNIQUE INDEX `CommentDislike_userId_commentId_key`(`userId`, `commentId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
